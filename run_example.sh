...
echo "$REGEX_CAPTURE" > $JH_DIR/filter/regex/capture_pattern.txt
echo "$REGEX_REPLACE" > $JH_DIR/filter/regex/replace_pattern.txt
...
start_cmd "jh-regex" "$JH_DIR/filter/regex/run.sh /tmp/rx0 /tmp/jh0 /tmp/lt0"
